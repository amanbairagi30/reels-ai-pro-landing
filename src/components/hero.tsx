    ...
    <>
      <section className="mt-10 relative">
        ...
        <div className="flex flex-col items-center justify-center gap-6 mt-20">
          <div className="top-[-35rem] md:top-[5rem] left-[20%] z-[-1] absolute bg-gradient-to-t opacity-50 dark:opacity-100 from-primary to-yellow-800  blur-[8em] rounded-xl transition-all translate-x-[-50%] duration-700 ease-out w-[10rem] md:w-[10rem] h-[20rem] md:h-[60rem] rotate-[54deg]"></div>
          <div className="top-[-42rem] -left-[50%rem] z-[-1] absolute bg-gradient-to-t from-primary to-purple-300 opacity-50  blur-[4em] md:blur-[8em] rounded-full w-[10rem] md:w-[30rem] h-[20rem] md:h-[40rem] transition-all duration-700 ease-out rotate-[50deg]"></div>
          ...
          <div className="flex flex-col items-center justify-center w-full md:w-[80%]">
            ...
            <h1 className="text-4xl text-center md:text-5xl xl:text-6xl">
